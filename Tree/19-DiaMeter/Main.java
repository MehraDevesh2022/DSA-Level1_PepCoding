 ...
 * 2. You are required to complete the body of diameter1 function. The function
 * is expected to return the number of edges between two nodes which are
 * farthest from each other in terms of edges.
